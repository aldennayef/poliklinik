                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url('periksa_pasien/'.$lp['daftar_poli_id'])?>"><button type="button" class="btn btn-danger btn-sm">
                                                <i class="fa fa-stethoscope"></i> Periksa</button></a>
                                            <?php } else{?>
                                            <button type="button" class="btn btn-success btn-sm btnDokterEditJadwal"
                                                data-id="<?=$lp['daftar_poli_id']?>" data-toggle="modal"
                                                data-target="#modal-ubahjadwal"><i class="fa fa-info"></i> Detail Periksa</button>
                                            <?php }?>
                                        </td>
                                    </tr>
                                    <?php }?>
